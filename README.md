...
To obtain the full dataset, I combined the test and train data into one dataset, as explained in the details section below.
...
run_analysis <- function()
{
  ...
  # Step 0: First it validates that you are running the script from the approporate directory. Otherwise it lets you know where you should run it.
  # Step 1: Merges the training and the test sets to create one data set.
  ...
  ## Step 3. Uses descriptive activity names to name the activities in the data set
    ...
    ## A findmyactivityname function is used to find the activity name of a corresponding activity code
